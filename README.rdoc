...
Optionally, you may want to update the plugins:

  $ cd ~/.vim && rake update:plugins

... note that this command only updates those plugins available via Git.
...
* {RDoc Syntax}[http://www.vim.org/scripts/script.php?script_id=2878]
